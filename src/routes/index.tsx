  ...
  const t = lang === "ru"
    ? {
        ...
        acqSteps: [
          ...
          { n: "02", title: "Нажмите «Написать в ТГ»", desc: "Отправьте запрос по понравившейся работе." },
