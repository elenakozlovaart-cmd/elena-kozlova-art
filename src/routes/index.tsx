...
function Index() {
  ...
  const t = lang === "ru"
    ? {
        ...
        heroName: "Елена\nКозлова",
        heroLead: "Современный художник-акварелист. \n\nЕлена работает с темами света, памяти, путешествий и внутренних состояний, создавая атмосферные акварели, в которых важны прозрачность, воздух и ощущение момента.",
