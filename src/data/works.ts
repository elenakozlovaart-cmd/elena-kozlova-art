...
export const works: Work[] = [
  ...
  { src: w17, src800: w17_800, price: { rub: 30000, eur: 300 }, ru: { c: "Городская лирика", t: "Тёплый след", s: "70 × 50 см", y: "2026", st: "В наличии", m: "Акварель, бумага на планшете", d: "Работа из серии «Сквозь дождь», построенной на эффекте капель на стекле и размытых огней города. Сердце, проведённое пальцем по запотевшему окну, становится тёплым следом чьего-то присутствия — коротким и хрупким, прежде чем его смоет дождь." }, en: { c: "Urban lyrics", t: "A Warm Trace", s: "70 × 50 cm", y: "2026", st: "Available", m: "Watercolour on paper on board", d: "Part of the \"Through the Rain\" series, built on the effect of raindrops on glass and the blurred lights of the city. A heart traced by a finger on a misted window becomes the warm trace of someone’s presence — brief and fragile, before the rain washes it away." } },
  { src: w18, src800: w18_800, price: { rub: 18000, eur: 180 }, ru: { c: "Городская лирика", t: "ПроСвет", s: "60 × 40 см", y: "2026", st: "В наличии", m: "Акварель, бумага на планшете", d: "Прозрачный купол зонта, последние капли и тёплые отражения витрин — момент, когда дождь стихает и небо начинает светлеть. Работа из серии «Сквозь дождь»." }, en: { c: "Urban lyrics", t: "ProSvet", s: "60 × 40 cm", y: "2026", st: "Available", m: "Watercolour on paper on board", d: "A transparent umbrella, the last drops, and warm reflections of shop windows — the moment when the rain quiets and the sky begins to clear. Part of the \"Through the Rain\" series." } },
  { src: w19, src800: w19_800, price: { rub: 18000, eur: 180 }, breakBefore: true, breakAfter: true, ru: { c: "Городская лирика", t: "Идущие по небу", s: "60 × 40 см", y: "2026", st: "В наличии", m: "Акварель, бумага на планшете", d: "Работа из серии «Сквозь дождь»: фигуры прохожих и отражения города будто продолжаются в светлом небе." }, en: { c: "Urban lyrics", t: "Walking in the Sky", s: "60 × 40 cm", y: "2026", st: "Available", m: "Watercolour on paper on board", d: "Part of the \"Through the Rain\" series: figures of passers-by and city reflections seem to continue into the bright sky." } },
  ...
  { src: w13, src800: w13_800, price: { rub: 18000, eur: 180 }, ru: { c: "Круглая серия", t: "Огни города", s: "d 50 см", y: "2025", st: "В наличии", m: "Акварель бумага на планшете, в раме", d: "Ночные огни, собранные в круг — городская мелодия, увиденная издалека и сведённая к чистому свету." }, en: { c: "Circular series", t: "City Lights", s: "d 50 cm", y: "2025", st: "Available", m: "Watercolour on paper on board, framed", d: "Night lights gathered into a circle — an urban melody seen from afar and distilled into pure light." } },
